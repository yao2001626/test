...
public class Lime {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if ( filename!=null ) input = new FileInputStream("ll/test.ll");
        else input = System.in;

        // CREATE LEXER/PARSER THAT CREATES AST FROM INPUT
        Lime2Lexer lexer = new Lime2Lexer(new ANTLRInputStream(input));
        TokenRewriteStream tokens = new TokenRewriteStream(lexer);
        Lime2Parser parser = new Lime2Parser(tokens);
        parser.setTreeAdaptor(cTreeAdaptor);
        Lime2Parser.r_return ret = parser.r();
...
/* 
        ...
        ClassLoader cl = Lime.class.getClassLoader();
